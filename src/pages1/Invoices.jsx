    ...
    return (
      ...
      >
        <Icon icon="iconamoon:eye-light" width={18} height={18} />
                    ...
                    <button
                      ...
                      title={invoice.active ? 'Delete Invoice' : 'Invoice Deleted'}
      ...
      {showCreateForm && (
        <>
          ...
          <div className="modal d-block" tabIndex="-1" style={{position:'fixed',inset:0,zIndex:1050,display:'flex',alignItems:'center',justifyContent:'center',width:'100vw',height:'100vh'}}>
            <div className="card shadow-lg" style={{minWidth: '380px', maxWidth: '450px', width: '100%', maxHeight: '90vh', overflowY: 'auto', margin:'auto'}}>
              <div className="card-header d-flex align-items-center justify-content-between">
                <h5 className="mb-0">Create Invoice</h5>
                <button type="button" className="btn btn-link text-danger fs-4 p-0 ms-2" aria-label="Close" onClick={() => setShowCreateForm(false)}>
