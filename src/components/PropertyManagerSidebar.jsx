...
import PropertyManagerCombinedDashboard from "./PropertyManagerCombinedDashboard";

const PropertyManagerSidebar = ({ children }) => {
      ...
      >
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            <li>
              <Link to='/propertymanager-dashboard'>
                <Icon
            ...
            <li>
              <NavLink to='/property-list-property-manager'>
            ...
            <li>
              ...
              >
               ...
               <li>
                          <Link to='/MaintainancePagePropertyManager'>
            ...
            {/* Settings Dropdown */}
            <li>
              <Link to='/propertymanagercompanylayer'>
                <Icon
