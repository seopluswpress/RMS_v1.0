...
const Settings1 = ({ basePath = "" }) => {
    const navigate = useNavigate();

    return (
        <div className="card h-100 p-0 radius-12 overflow-hidden">
            <div className="d-flex flex-wrap gap-2 p-3 pb-0">
                <button className="btn" style={{backgroundColor:'#30314f',color:'#fff'}} onClick={() => navigate(`${basePath}/notification`)}>Notification</button>
            
        
            
    
                <button className="btn" style={{backgroundColor:'#30314f',color:'#fff'}} onClick={() => navigate(`${basePath}/payment-gateway`)}>Payment Gateway</button>
