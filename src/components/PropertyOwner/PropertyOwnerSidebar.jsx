        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            */}
            ...
            <li>
              <NavLink to='/tenant-screening' className={(navData) => (navData.isActive ? "active-page" : "")}>
              ...
              <div className='col-auto'>
                <div className='d-flex flex-wrap align-items-center gap-3'>
                  ...
                  <div className="d-flex align-items-center" style={{ flex: 1, justifyContent: 'flex-end' }}>
                    <div className="marquee-container me-2" style={{ flex: 1, overflow: 'hidden', whiteSpace: 'nowrap' }}>
                      <div className="marquee-text" style={{ animation: 'marquee 10s linear infinite', color: '#ff6b6b', fontWeight: 'bold', fontSize: '0.85rem' }}>
                        plan expiring soon, upgrade now
                      </div>
                    </div>
